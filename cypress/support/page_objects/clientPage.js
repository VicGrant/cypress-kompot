...
class ClientDetails {
    ...
    get additionalInfo(){return cy.get('[id="additionalInfo"]')};
...
export default class ClientPage{
    ...
    headerCreateNewClient =() => cy.get('.css-95g4uk').should('contain','Create New Client')
...
//export const getClientPage = new ClientPage()